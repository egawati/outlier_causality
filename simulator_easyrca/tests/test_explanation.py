...
from easyrca_simulator.explanation import run_easyrca_explain_outlier
from easyrca_simulator.explanation import ExplainerEasyRCAMP
...
class TestExplanation(unittest.TestCase):
	...
	def test_explainer_easyrca(self):
	...
	def test_explainer_easyrca2(self):
		outlier_queue = self.manager.Queue()
		ex_window_queue = self.manager.Queue()
		explainer_queue = self.manager.Queue()
	...
	def test_explainer_easyrca3(self):
		outlier_queue = self.manager.Queue()
		ex_window_queue = self.manager.Queue()
		explainer_queue = self.manager.Queue()
	...
	def test_explainer_easyrca4(self):
		outlier_queue = self.manager.Queue()
		ex_window_queue = self.manager.Queue()
		explainer_queue = self.manager.Queue()
		...
		explainer = ExplainerEasyRCAMP(self.window_size, 
						   self.slide_size, 
						   slide_number,
						   self.causal_graph, 
						   ex_window_queue,
	...
	def test_explainer_easyrca5(self):
		outlier_queue = self.manager.Queue()
		ex_window_queue = self.manager.Queue()
		explainer_queue = self.manager.Queue()
