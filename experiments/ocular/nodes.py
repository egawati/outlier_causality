...
if __name__ == '__main__':
    ...
    vary_num_nodes = [i for i in range(3,11)]
    ...
    ip = '127.0.0.1'
    port = 49775
    slide_size = 24 # in seconds
    window_size = 96 # in seconds
    rate = 0.1
    nslide_used = 2
    ...
    for num_nodes in vary_num_nodes:
        ...
        for root_cause in gt_root_causes:
            ...
            if root_cause_metadata == root_cause:
                print(f'Experiment on {num_nodes} where root causes = {root_cause} and target_node = {target_node}')
            else:
                break
