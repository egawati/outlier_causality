...
from EasyRCA.estimation import FisherZ
import random
...
if __name__ == '__main__':
    ...
    res0 = cloud_ranger0(g, data, anomalous_nodes=anomalous, anomalies_start_time=anomalies_start, anomaly_length=anomaly_length, sig_threshold=0.05)
    print(res0)
