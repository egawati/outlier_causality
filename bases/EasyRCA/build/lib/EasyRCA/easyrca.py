...
import pandas as pd
import numpy as np
from EasyRCA.identification import remove_self_loops, backdoor_from_summary_graph, singledoor_from_summary_graph
from EasyRCA.estimation import FisherZ, grubb_test, LinearRegression
...
class EasyRCA:
    ...
    def _process_data(self, data):
        ...
        for gamma in range(0, 2 * self.gamma_max + 1):
            ...
            #print(f'shifteddata.shape {shifteddata.shape}')
        ...
        #print(f'self.anomalies_start_time[self.anomalous_nodes[0]] {self.anomalies_start_time[self.anomalous_nodes[0]]}')
        #print(f'first_end_time_normal is {first_end_time_normal}')
        ...
        #print(f'normal_data shape after first {normal_data.shape}')
    ...
    def run(self, data):
        ...
        if normal_data.shape[0] == 0 or anomalous_data.shape[0]==0:
            return
        for subgraph_id in self.dict_linked_anomalous_graph.keys():
