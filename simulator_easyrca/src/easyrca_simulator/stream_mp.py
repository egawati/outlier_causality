...
def run_easyrca_simulator_mp(tcp_server, 
                         slide_size, 
                         window_size, 
                         start_ts, 
                         msg_size, 
    ...
    print(f'gamma_max at stream_mp is {gamma_max}')
    ...
    for _ in range(n_streams):
        ...
        explainer = ExplainerEasyRCAMP(window_size, 
                                slide_size, 
                                slide_number,
                                causal_graph, 
                                we_queues[-1],
    ...
    logging.info('EasyRCA simulator finished')
