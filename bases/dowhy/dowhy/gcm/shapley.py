...
# logging.basicConfig(filename='myapp.log', format='%(message)s', level=logging.INFO)
...
def estimate_shapley_values(
    ...
    logging.info(f'estimate_shapley_values')
    logging.info(f'shapley_config {shapley_config.approximation_method}')
    logging.info(f'shapley_config.n_jobs {shapley_config.n_jobs}')
    ...
    print(f'approximation_method is {approximation_method}')
...
def _estimate_shapley_values_exact(
    ...
    print('HERE')
    # logging.info(f'all_subsets is {all_subsets}')
    # logging.info(f'total number of subsets/permutation is {len(all_subsets)}')
    # logging.info(f'subset_to_result_map  use set_func that is in anomaly_scores module line 208')
    ...
    #logging.info(f'subset_to_result_map {subset_to_result_map}')
    # print(f'subset_to_result_map')
    # for key in subset_to_result_map:
    #     print(f'({key}) --> {subset_to_result_map[key]}')
    # logging.info(f'the value of each permutation in the subset_to_result_map is the outlier score of the outlier noise in each permutation\n\n')
    subset_weight_cache = {}

    # print(f'---------------------------------------------------------\n')
    # logging.info(f'now use the subset_to_result_map to compute shapley_values')
    shapley_values = [None] * num_players
    subsets_missing_one_player = np.array(list(itertools.product([0, 1], repeat=num_players - 1)))
    # print(f'subsets_missing_one_player is {subsets_missing_one_player}')
    for player_index in range(num_players):
        ...
        # print(f'subsets_with_player for player {player_index} is {subsets_with_player}')
        # print(f'subsets_without_player for player {player_index} is {subsets_without_player}')
        ...
        for i in range(len(subsets_with_player)):
            ...
            # if i < 5:
            #     print(f'{subsets_with_player[i]} with score {subset_to_result_map[subsets_with_player[i]]}')
            #     print(f'{subsets_without_player[i]} with score {subset_to_result_map[subsets_without_player[i]]}')
            #     print(f'score difference is {subset_to_result_map[subsets_with_player[i]] - subset_to_result_map[subsets_without_player[i]]}')
            #     print(f'weigthed score difference is {weighted_diff}')
            ...
            if shapley_values[player_index] is None:
                ...
                shapley_values[player_index] += weighted_diff
    # print(f'subset_weight_cache is {subset_weight_cache} ')
    # logging.info(f'the shapley_values is {np.array(shapley_values).T}')
    # print(f'---------------------------------------------------------')
...
def _approximate_shapley_values_via_least_squares_regression(
    ...
    print(f'len of all_subsets is {len(all_subsets)}')
...
def _approximate_shapley_values_via_early_stopping(
    ...
    if config.show_progress_bars:
        pbar.update(1)
        pbar.close()
    print(f'num_generated_permutations {num_generated_permutations}')
...
def _create_subsets_and_weights_exact(num_players: int, high_weight: float) -> Tuple[np.ndarray, np.ndarray]:
    ...
    print(f'len all_subsets is {len(all_subsets)}')
...
def _create_subsets_and_weights_approximation(
    ...
    print(f'num_subset_samples is {num_subset_samples}')
